...
proof have nothing to do with simulation or emulation. In functional languages like
Haskell, functions are first-order objects and can be manipulated, filtered,
formally composed with other functions, and so on, without ever actually needing to
be executed.
In the same way, if $X$ knows the code
...
those axioms.
% In fact, G\"odel constructively tells us how to obtain such a
