...
this paper. If the reader will accept that mathematical induction works
on the ordinals like on $\mathbb N$, we can argue as follows.
...
$\alpha'>\alpha''>\cdots$ would be an IDS starting at $\alpha'<\alpha$,
