...
In Section 6 of \cite{alexander2019measuring} we suggest a hypothetical way
these idealized results could be applied to certain less-idealized AGIs.}) are true,
...
that $X$ knows the truthfulness\footnote{If the created AGI could eventually deduce
a contradiction, then, at least in classical mathematics,
it could also deduce things like ``I should kill my creator''.}
...
knows the code and truthfulness of $Y$, then $Y$ is less intelligent
than $X$ in a certain formal sense.
...
Whatever an AGI is, presumably an AGI knows (or could eventually deduce) certain
mathematical facts.
...
independently of the surrounding collective of other agents
...
one important aspect of an AGI's intelligence.}. An AGI could be good at problem-solving
...
Albert Visser, and the reviewers for comments and feedback.
