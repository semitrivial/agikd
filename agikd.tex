...
In some sense, examples \ref{simpleexamples} and \ref{omegaexample} exemplify
Franz's approach of ``head[ing] for general algorithms at low complexity levels
...
a knowledge-set of mathematical facts.}. An AGI may be good at video games
but poor at ordinals,
...
measure something having to do with an AGI's abilities. It is possible that
...
We acknowledge Thomas Forster, Jos{\'e} Hern{\'a}ndez-Orallo, Bill Hibbard, and Mike Steel
